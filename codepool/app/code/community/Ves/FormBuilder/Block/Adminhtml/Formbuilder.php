...
class Ves_FormBuilder_Block_Adminhtml_Formbuilder extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    ...
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper("ves_formbuilder")->__("Custom Forms Manager");
        $this->_addButtonLabel = Mage::helper("ves_formbuilder")->__("Create New Form");
        parent::__construct();
