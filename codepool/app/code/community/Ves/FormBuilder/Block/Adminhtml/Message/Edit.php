 ...
 */
class Ves_FormBuilder_Block_Adminhtml_Message_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry("message_data") && Mage::registry("message_data")->getId()) {
            return Mage::registry("message_data")->getFormName();
        }
        return Mage::helper("ves_formbuilder")->__("View Message");
    }
}