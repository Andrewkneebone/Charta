 ...
 */
class Ves_FormBuilder_Block_Adminhtml_Modelcategory_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('status', array(
            ...
            'index' => 'status',
            'type' => 'options',
            'options' => Ves_FormBuilder_Block_Adminhtml_Modelcategory_Grid::getOptionYesNo(),
            ));
...
{
    $data_array = array();
    foreach (Ves_FormBuilder_Block_Adminhtml_Modelcategory_Grid::getOptionYesNo() as $k => $v) {
