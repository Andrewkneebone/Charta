 ...
 */
class Ves_FormBuilder_Block_Adminhtml_Modelcategory_ExportGrid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _filterProductNameCondition($collection, $column)
    {
        ...
        $this->getCollection()->getSelect()->group("main_table.category_id");
    }
