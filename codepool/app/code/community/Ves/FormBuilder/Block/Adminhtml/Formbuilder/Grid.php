 ...
 */
class Ves_FormBuilder_Block_Adminhtml_Formbuilder_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn("title", array(
            "header" => Mage::helper("ves_formbuilder")->__("Form Name"),
            "align" => "left",
            "index" => "title",
        ...
        $this->addColumn('status', array(
            ...
            'index' => 'status',
            'type' => 'options',
            'options' => Ves_FormBuilder_Block_Adminhtml_Formbuilder_Grid::getOptionYesNo(),
            ));
...
protected function _prepareMassaction()
{
    ...
    $this->getMassactionBlock()->addItem('remove_block', array(
        'label' => Mage::helper('ves_formbuilder')->__('Remove Custom Form'),
