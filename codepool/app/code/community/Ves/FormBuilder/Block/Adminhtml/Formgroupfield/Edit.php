 ...
 */
class Ves_FormBuilder_Block_Adminhtml_Formgroupfield_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry("form_data") && Mage::registry("form_data")->getId()) {
            ...
            return Mage::helper("ves_formbuilder")->__("Create Custom Form");
