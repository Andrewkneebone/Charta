 ...
 */
class Ves_FormBuilder_Block_Adminhtml_Formbuilder_Exportgrid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn("custom_css", array(
            "header" => Mage::helper("ves_formbuilder")->__("custom_css"),
            "align" => "right",
            "width" => "30%",
            "index" => "custom_css",
        ));

        $this->addColumn("custom_js", array(
            "header" => Mage::helper("ves_formbuilder")->__("custom_js"),
            "align" => "right",
            "width" => "30%",
            "index" => "custom_js",
        ));
