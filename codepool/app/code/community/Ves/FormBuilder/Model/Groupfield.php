 ...
 */
class Ves_FormBuilder_Model_Groupfield extends Mage_Core_Model_Abstract
{
    const CACHE_BLOCK_TAG            = 'ves_formbuilder_groupfield';
    const FIELD_NAME_PREFIX          = 'vesfield_';

    protected function _construct() {
        $this->_init('ves_formbuilder/groupfield');
    }
