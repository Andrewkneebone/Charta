(function() {
  rivets.binders.input = {
    ...
    bind: function(el) {
      return $j(el).bind('input.rivets', this.publish);
    },
    unbind: function(el) {
      return $j(el).unbind('input.rivets');
    }
  };
...
(function() {
  ...
  FormbuilderModel = (function(_super) {
    ...
    FormbuilderModel.prototype.indexInDOM = function() {
      var $wrapper,
      _this = this;
      $wrapper = $j(".fb-field-wrapper").filter((function(_, el) {
        return $j(el).data('cid') === _this.cid;
      }));
      return $j(".fb-field-wrapper").index($wrapper);
    };
    ...
    ViewFieldView.prototype.render = function() {
      ...
      BuilderView = (function(_super) {
        ...
        BuilderView.prototype.bindSaveEvent = function() {
          ...
          return $j(window).bind('beforeunload', function() {
            if (_this.formSaved) {
              return void 0;
            } else {
        ...
        BuilderView.prototype.bindWindowScrollEvent = function() {
          var _this = this;
          return $j(window).on('scroll', function() {
            var maxMargin, newMargin;
            if (_this.$fbLeft.data('locked') === true) {
              return;
            }
            newMargin = Math.max(0, $j(window).scrollTop() - _this.$el.offset().top);
        ...
        BuilderView.prototype.showTab = function(e) {
          ...
          $j(target).addClass('active').siblings('.fb-tab-pane').removeClass('active');
          if (target !== '#editField') {
        ...
        BuilderView.prototype.setDraggable = function() {
          ...
          return $addFieldButtons.draggable({
            ...
            helper: function() {
              var $helper;
              $helper = $j("<div class='response-field-draggable-helper' />");
              $helper.css({
        ...
        BuilderView.prototype.addField = function(e) {
          var field_type;
          field_type = $j(e.currentTarget).data('field-type');
        ...
        BuilderView.prototype.createAndShowEditView = function(model) {
          ...
          $responseFieldEl = this.$el.find(".fb-field-wrapper").filter(function() {
            return $j(this).data('cid') === model.cid;
          });
        ...
        BuilderView.prototype.ensureEditViewScrolled = function() {
          ...
          return this.scrollLeftWrapper($j(".fb-field-wrapper.editing"));
        };
        ...
        BuilderView.prototype.scrollLeftWrapper = function($responseFieldEl) {
          ...
          return $j.scrollWindowTo((this.$el.offset().top + $responseFieldEl.offset().top) - this.$responseFields.offset().top, 200, function() {
      ...
      Formbuilder = (function() {
        ...
        Formbuilder.options = {
          ...
          mappings: {
            ...
            CUSTOM_ID: 'custom_id',
            PRODUCT_ATTRIBUTE_CODE: 'attribute_code',
...
(function() {
  Formbuilder.registerField('email', {
    ...
    edit: "<%= Formbuilder.templates['edit/field_id']() %>\n<%= Formbuilder.templates['edit/email']({ includeBlank: true }) %>\n<%= Formbuilder.templates['edit/bootstrapcol']() %>\n<%= Formbuilder.templates['edit/extraoptions']() %>",
...
(function() {
  Formbuilder.registerField('paragraph', {
    order: 5,
    view: "<textarea class='col-sm-<%= rf.get(Formbuilder.options.mappings.FIELDCOL) %>' style='height: <%= rf.get(Formbuilder.options.mappings.FIELD_HEIGHT) %>'></textarea>",
...
(function() {
  Formbuilder.registerField('price', {
    order: 45,
    view: "<div class='input-line'>\n  <span class='above-line' style='width: 3%; float: left'>$</span>\n  <span class='dolars' style='width: 97%'>\n    <input type='text' class='col-sm-<%= rf.get(Formbuilder.options.mappings.FIELDCOL) %>'/>\n</div>",
    edit: "<%= Formbuilder.templates['edit/field_id']() %>\n<%= Formbuilder.templates['edit/productattribute']() %>\n<%= Formbuilder.templates['edit/bootstrapcol']() %>\n<%= Formbuilder.templates['edit/extraoptions']() %>",
...
(function() {
  Formbuilder.registerField('start_group', {
    order: 0,
    type: 'non_input',
    view: "",
    edit: "<%= Formbuilder.templates['edit/field_id']() %>\n<div class='fb-edit-section-header'>Start Group Tag</div><br/>Label<br/>\n<input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.LABEL %>' /><br/>\n<input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.GROUP_TAG %>' />\n<br/>Input HTML Tag Name for start group. Ex: fieldset, div,...\n<br/><label>Custom Field ID</label><br/><input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.CUSTOM_ID %>' />\n<br/><label>Custom Css Class</label><br/>\n<input type=\'text\' data-rv-input=\'model." +((__t = ( Formbuilder.options.mappings.CUSTOMCLASS )) == null ? '' : __t) +
    "'\n placeholder=\'Add Custom Css Class\' />\n<%=  Formbuilder.templates['edit/bootstrapwrappercol']() %>\n<%= Formbuilder.templates['edit/extraoptions']() %>\n",
    addButton: "<span class='symbol'><span class='fa fa-angle-left'></span></span> Start Group Tag"
  });

}).call(this);

(function() {
  Formbuilder.registerField('end_group', {
    order: 1,
    type: 'non_input',
    view: "",
    edit: "<%= Formbuilder.templates['edit/field_id']() %>\n<div class='fb-edit-section-header'>End Group Tag</div><br/>Label<br/>\n<input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.LABEL %>' /><br/>\n<input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.GROUP_TAG %>' />\n<br/>Input HTML Tag Name for start group. Ex: fieldset, div,...\n",
    addButton: "<span class='symbol'><span class='fa fa-angle-right'></span></span> End Group Tag"
  });
...
(function() {
  Formbuilder.registerField('html', {
   ...
   type: 'non_input',
   view: "",
   edit: "<%= Formbuilder.templates['edit/field_id']() %>\n<div class='lof-fieldset'><div class='fb-edit-section-header'>Label</div> <div class='fb-edit-section-content'><input type='text' data-rv-input='model.<%= Formbuilder.options.mappings.LABEL %>' />\n <label style='display: block;border-bottom: 1px solid #ddd;margin-top: 25px;margin-bottom: 10px;padding-bottom: 5px;clear: both;font-weight: 700;''>Description:</label><textarea style='width: 100%;height: 259px;' type='text' data-rv-input='model.<%= Formbuilder.options.mappings.DESCRIPTION %>' /></div></div>\n<%= Formbuilder.templates['edit/productattribute']() %>\n<%=  Formbuilder.templates['edit/bootstrapwrappercol']() %>\n<%= Formbuilder.templates['edit/extraoptions']() %>\n",
...
(function() {
  Formbuilder.registerField('text', {
    order: 0,
    view: "<input type='text' class='col-sm-<%= rf.get(Formbuilder.options.mappings.FIELDCOL) %>' />",
    edit: "<%= Formbuilder.templates['edit/field_id']() %>\n<%= Formbuilder.templates['edit/validation']() %>\n<%= Formbuilder.templates['edit/min_max_length']() %>\n<%= Formbuilder.templates['edit/productattribute']() %>\n<%= Formbuilder.templates['edit/custom_input']() %>\n<%= Formbuilder.templates['edit/bootstrapcol']() %>\n<%= Formbuilder.templates['edit/extraoptions']() %>\n",
...
this["Formbuilder"]["templates"]["edit/email"] = function(obj) {
  ...
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '\n<div class="fb-edit-section-header">Default Email</div>\n\n<div class="fb-common-wrapper">'+
    '\n  <label><input type=\'checkbox\' data-rv-checked=\'model.' +
    ((__t = ( Formbuilder.options.mappings.USE_CUSTOMER_EMAIL )) == null ? '' : __t) +
    '\' />\n  Use Customer Email</label>\n\n</div><div class="fb-common-wrapper">\n\n<label>Default Email</label>'+
    '\n<br/><input type=\'text\' data-rv-input=\'model.' +
    ((__t = ( Formbuilder.options.mappings.DEFAULT_EMAIL )) == null ? '' : __t) +
    '\' />\n</div>\n\n<div class="fb-common-wrapper">'+
    '\n  <label><input type=\'checkbox\' data-rv-checked=\'model.' +
    ((__t = ( Formbuilder.options.mappings.SENDER_EMAIL )) == null ? '' : __t) +
    '\' />\n Is Sender Email?</label>\n\n</div>';

  }
  return __p
};

this["Formbuilder"]["templates"]["edit/custom_input"] = function(obj) {
  obj || (obj = {});
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class="fb-edit-section-header">Extra Config</div>\n'+
    '\n\n<div class="fb-common-wrapper"><label>\n  <input type=\'checkbox\' data-rv-checked=\'model.' +
    ((__t = ( Formbuilder.options.mappings.IS_HIDDEN_FIELD )) == null ? '' : __t) +
    '\' />\n Is Hidden Field\n</label></div>\n'+
    '\n<div class="fb-edit-section-header">Default Config</div>'+
    '\n<div class="fb-common-wrapper"> <label>Default Value\n<br/><input type=\'text\' data-rv-input=\'model.' +
    ((__t = ( Formbuilder.options.mappings.DEFAULT_INPUT )) == null ? '' : __t) +
    '\' />\n\n</label></div>\n<div class="fb-common-wrapper"> '+
    '\n\n<label>Use Customer Info\n<br/><select data-rv-value="model.' +
    ((__t = ( Formbuilder.options.mappings.CUSTOMER_INFO )) == null ? '' : __t) +
    '" style="width: auto;">\n <option value="">Choose A Option</option>'+
    '\n  <option value="customer_id">Customer ID</option>'+
    '\n  <option value="customer_name">Customer Name</option>'+
    '\n  <option value="customer_email">Customer Email</option>'+
    '\n  <option value="customer_firstname">Customer First Name</option>'+
    '\n  <option value="customer_lastname">Customer Last Name</option>'+
    '\n  <option value="customer_dob">Customer Birthday</option>'+
...
this["Formbuilder"]["templates"]["edit/extraoptions"] = function(obj) {
  ...
  with (obj) {
    __p += '<div class="lof-fieldset">';
    __p += '<div class=\'fb-edit-section-header\' data-role="title">Custom Inline Css</div>';
    __p += '<div class="fb-edit-section-content row" data-role="content">';
    __p += '<div class="col-sm-12">';
    __p += '<textarea style="width: 100%" data-rv-input="model.'+((__t = ( Formbuilder.options.mappings.INLINE_CSS )) == null ? '' : __t) +'"></textarea>\n';
    __p += 'Add css code. Example: margin-right: 10px; padding-left: 5px';
    __p += '</div>';
    __p += '</div>';
    __p += '</div>';

    __p += '<div class="lof-fieldset">';
    __p += '<div class=\'fb-edit-section-header\' data-role="title">Custom HTML Properties</div>';
    __p += '<div class="fb-edit-section-content row" data-role="content">';
    __p += '<div class="col-sm-12">';
    __p += '<textarea style="width: 100%" data-rv-input="model.'+((__t = ( Formbuilder.options.mappings.OTHER_PROPERTY )) == null ? '' : __t) +'"></textarea>\n';
    __p += 'Add custom html tag properties. Do not input duplicate properties.\n<br/>Example: onchange="functionname();" data-custom="field_value" onclick="return true;" ...';
    __p += '</div>';
    __p += '</div>';
    __p += '</div>';
  }
...
this["Formbuilder"]["templates"]["edit/productattribute"] = function(obj) {
  obj || (obj = {});
  var __t, __p = '', __e = _.escape;
  with (obj) {
    __p += '<div class="lof-fieldset">';
    __p += '<div class=\'fb-edit-section-header\' data-role="title">Product Attribute Code</div>';
    __p += '<div class="fb-edit-section-content row" data-role="content">';
    __p += '<div class="col-sm-12">';
    __p += '<input type="text" style="width: 100%" data-rv-input="model.'+((__t = ( Formbuilder.options.mappings.PRODUCT_ATTRIBUTE_CODE )) == null ? '' : __t) +'"/>\n';
    __p += 'Add product attribute code. <br/>The field auto get current product attribute values by code to use as default value of text field or options in dropdown field.';
    __p += '</div>';
    __p += '</div>';
    __p += '</div>';
  }
...
this["Formbuilder"]["templates"]["edit/label_description"] = function(obj) {
  ...
  with (obj) {
    ...
    '\n\n Custom Css Class \n<input type=\'text\' data-rv-input=\'model.' +
    ((__t = ( Formbuilder.options.mappings.CUSTOMCLASS )) == null ? '' : __t) +
    '\'\n placeholder=\'Add Custom Css Class\' />';
...
this["Formbuilder"]["templates"]["edit/validation"] = function(obj) {
  ...
  __p += '<div class=\'fb-edit-section-header\'>Magento Validations</div>\n\n';
  
  __p += '<div class=\'fb-edit-section-helper\'>Choose the form field validation types</div>\n';

  __p += '\n\n<select style="max-width: 200px;" class="field-type-validation" data-rv-value="model.' +
  ((__t = ( Formbuilder.options.mappings.VALIDATION )) == null ? '' : __t) +
  '">\n';
  
  __p +='<option value="">Select Type</option>\n';
  if(typeof(field_validation_array) != "undefined" && field_validation_array.length > 0) {
    field_validation_array.forEach(function(item, index) {
      var item_key_arr = Object.keys(item).map(function(value) { return value; });
      if(typeof(item_key_arr) != "undefined"){
        __p +='<option value="'+item_key_arr[0]+'">'+item[item_key_arr[0]]+'</option>\n';
      }
    })
  }
  __p +='</select>\n';
...
this["Formbuilder"]["templates"]["edit/google_map"] = function(obj) {
  ...
  with (obj) {
    ...
    __p += '<div class="afield" style="padding: 5px 0;"><span>Show Map Location:</span> <select data-rv-value="model.' +
    ((__t = ( Formbuilder.options.mappings.SHOW_MAP_LOCATION )) == null ? '' : __t) +
    '">\n  <option value="1">Show</option>\n  <option value="0">Hide</option>\n</select>\n';
    __p += '</div>';

    __p += '<div class="afield" style="padding: 5px 0;"><span>Show Radius</span> <select data-rv-value="model.' +
...
this["Formbuilder"]["templates"]["edit/file_upload"] = function(obj){
  ...
  with (obj) {
    ...
    __p += '<p>Field type</p>';
    __p += '<input name="file_type" data-rv-input="model.' +
    ...
    __p += '<input name="maximum_size" data-rv-input="model.' +
...
this["Formbuilder"]["templates"]["view/base_non_input"] = function(obj) {
  ...
  with (obj) {
    ...
    if(field_type == 'start_group'){
      ((__p += ( Formbuilder.templates['view/start_group_label']({rf: rf}) )) == null ? '' : __t);
    }

    if(field_type == 'end_group'){
      ((__p += ( Formbuilder.templates['view/end_group_label']({rf: rf}) )) == null ? '' : __t);
    }
...
this["Formbuilder"]["templates"]["view/start_group_label"] = function(obj) {
  obj || (obj = {});
  var __t,__w,__z,__a,__b,__v, __p = '', __e = _.escape, __j = Array.prototype.join;
  function print() { __p += __j.call(arguments, '') }
  with (obj) {
    var custom_css_class = ((__a = ( rf.get(Formbuilder.options.mappings.CUSTOMCLASS) )) == null ? '' : __a);
    var width_class = ((__b = ( rf.get(Formbuilder.options.mappings.WRAPPERCOL) )) == null ? '' : ' col-sm-'+__b);
    var css_class_attr = (custom_css_class || width_class)?(' class="'+custom_css_class+width_class+'"'):'';
    __p += '<div class="field-section-break">\n  <span>Group Tag &lt;' +
    ((__t = ( Formbuilder.helpers.simple_format(rf.get(Formbuilder.options.mappings.GROUP_TAG)) )) == null ? '' : __t) + ((__w = (rf.get(Formbuilder.options.mappings.CUSTOM_ID) )) == null ? '' : ' id="'+__w+'"')+css_class_attr+((__z = (rf.get(Formbuilder.options.mappings.INLINE_CSS) )) == null ? '' : ' style="'+__z+'"')+' '+((__v = ( rf.get(Formbuilder.options.mappings.OTHER_PROPERTY) )) == null ? '' : __v)+
    '&gt;</span> ';
    __p += '\n</div>\n';
...
this["Formbuilder"]["templates"]["view/end_group_label"] = function(obj) {
  obj || (obj = {});
  var __t, __p = '', __e = _.escape, __j = Array.prototype.join;
  function print() { __p += __j.call(arguments, '') }
  with (obj) {
    __p += '<div class="field-section-break">\n  <span>&lt;/' +
    ((__t = ( Formbuilder.helpers.simple_format(rf.get(Formbuilder.options.mappings.GROUP_TAG)) )) == null ? '' : __t) +
    '&gt;</span> ';
    __p += '\n</div>\n';
